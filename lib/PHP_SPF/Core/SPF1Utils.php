...
class SPF1Utils {
    ...
    const DEFAULT_EXPLANATION = "http://www.openspf.org/why.html?sender=%{S}&ip=%{I}";
    const BEST_GUESS_RECORD = "v=spf1 a/24 mx/24 ptr ?all";
    const ATTRIBUTE_SPF1_RECORD = "SPF.SPF1Record";
     ...
     */
    public static function resultToName($result) {
     ...
     */
    public static function checkFQDN($host) {
